...
process_execute (const char *file_name)
{
  ...
  tid_t tid = thread_create (file_name, PRI_DEFAULT, start_process, addr);
  if (tid == TID_ERROR)
    {
...
process_exit (void)
{
  ...
  // evict all pages and remove data
  page_clear_page_table ();
